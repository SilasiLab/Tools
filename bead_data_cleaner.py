...
class buildDFs:
    ...
    def make_output_df(self, level):
        if level == 1:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 1'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 1'].dropna().unique()]
            ...
            return output_df_1
        if level == 2:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 2'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 2'].dropna().unique()]
            ...
            return output_df_2
        if level == 3:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 3'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 3'].dropna().unique()]
            ...
            return output_df_3
        if level == 4:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 4'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 4'].dropna().unique()]
            ...
            return output_df_4
        if level == 5:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 5'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 5'].dropna().unique()]
            ...
            return output_df_5
        if level == 6:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 6'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 6'].dropna().unique()]
            ...
            return output_df_6
        if level == 7:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 7'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 7'].dropna().unique()]
            ...
            return output_df_7
        if level == 8:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 8'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 8'].dropna().unique()]
            ...
            return output_df_8
        if level == 9:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 9'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 9'].dropna().unique()]
            ...
            return output_df_9
        if level == 10:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 10'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 10'].dropna().unique()]
            ...
            return output_df_10
        if level == 11:
            unique_regions_L = ['L_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 11'].dropna().unique()]
            unique_regions_R = ['R_' + self.ID_to_name[x] + '_' + str(int(x)) for x in self.atlas_df['Level 11'].dropna().unique()]
            unique_regions_11 = unique_regions_L + unique_regions_R
            print(unique_regions_11)
...
class fillDFS:
    ...
    def fill_df(self, mouse, hemi, level):      
        ...
        for k, v in leveled_counts.items():
            if LEFT:
                named_counts['L_' + self.ID_to_name[k] + '_' + str(int(k))] = [v]
            else:
                named_counts['R_' + self.ID_to_name[k] + '_' + str(int(k))] = [v]
    ...
    def combine_data(self):
        ...
        cols = list(level11_df.columns.values)
        print(cols)
        print(type(cols))
        cols.sort(lambda x: (x.split('_')[1:-1], x[0]))
        level11_df = level11_df[cols]
